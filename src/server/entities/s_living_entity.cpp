#include "s_living_entity.h"
#include <scene/3d/navigation_agent_3d.h>

void S_LivingEntity::_notification(int p_notification)
{
...
void S_LivingEntity::movement_process_frame()
{
...
void S_LivingEntity::set_movement_target_position(Vector3 target_pos)
{
